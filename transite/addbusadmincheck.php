...
if(isset($_POST['checkedbus']))
{
   ...
   if (mysqli_num_rows($res)) {
    while ($rows = mysqli_fetch_assoc($res)) {	
     ...
     if($busno==$busno2)
{
    header("location: addbusadmin.php?erro=busno_already_registered");
    exit();
}
                ...
                <div id="pass">
                    ...
                    <center>
                        ...
                        <input type="text" name="amount" value=""><br><br>
                            ...
                            <button type="submit" name=""formaction="addbusadmin.php">cancel</button> 
